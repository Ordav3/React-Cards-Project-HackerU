        ...
        {selectedUser && (
          <div>
            ...
            <TextField
              label="Middle Name"
              value={
                editedUser ? editedUser.middleName : selectedUser.middleName
              }
              onChange={(e) =>
            ...
            <TextField
              ...
              onChange={(e) => onEdit({ ...editedUser, phone: e.target.value })}
              variant={isMobile ? "outlined" : "standard"}
              margin={"normal"}
            />
            <TextField
              ...
              onChange={(e) => onEdit({ ...editedUser, email: e.target.value })}
              variant={isMobile ? "outlined" : "standard"}
              margin={"normal"}
            />
            <TextField
            ...
            <TextField
              label="House Number"
              value={
                editedUser ? editedUser.houseNumber : selectedUser.houseNumber
              }
              onChange={(e) =>
